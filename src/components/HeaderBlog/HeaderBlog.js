          ...
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6 ">
              ...
              <p className="text-base text-gray-700 md:text-lg text-justify">
                Tech Quiz is an Edtech company highly inspired by technology to
                facilitate technical & non technical education besides
                contemporary learning. We at Tech Quiz, are dedicated to
                exploring the new future of young minds through integrating the
                learning with creativity, sharing, and collaboration.
              </p>
            </div>
            <a
              href="/"
